...
function Index() {
  ...
  return (
    <div className="amorr" style={{ height: '100vh', }}>
      <h1 className="mt-5 text-center text-danger"> Amor verdadero</h1>
    </div>
  )
  ...
  //           <a className="text-left navbar-brand col-md-6 col-sm-6 pasta" href="#">
  //             <img
  ...
  //                 role="button"
  //               >
  //                 <svg className="whatsapp bi bi-whatsapp" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
  ...
  //                 role="button"
  //               >
  //                 <svg className="facebookbi bi-facebook " xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
  ...
  //                 role="button"
  //               >
  //                 <svg className="instagram bi bi-instagram" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
