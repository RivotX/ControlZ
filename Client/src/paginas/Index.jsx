            ...
            <form action="paginas/principal.php" method="post">
                    <div class="text-center mb-2">
                        ...
                        <button type="button" class="btn btn-secondary btn-floating mx-1">
                            <i class="fab fa-facebook-f"><svg id="svg1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                                </svg></i>
                        </button>

                        <button type="button" class="btn btn-secondary btn-floating mx-1">
                            <i class="fab fa-google"><svg id="svg1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
                    ...
                    <div class="container-fluid mt-3 mb-5">
                        <div class="row text-center">
                            ...
                            <input type="submit" class=" botonsiguiente " value="Siguiente" name="submit"/>
        ...
        <div class=" d-flex justify-content-center align-items-center">
          <div class="loginRegistro login-box reg " id="registrar">
            ...
            <form id="enviarphp" action="index.php" method="post">
                    ...
                    <p id="mensaje2" class="alert alert-danger" style={{display: "none"}}>Minimo 8 caracteres</p>

                    <div class="user-box regNormal">
                        <input type="password" name="clave2" id="clave2" oninput="inputIguales()" required/>
                        <label>Repetir contraseña</label>
                        <p id="mensaje" class="alert alert-warning" style={{display: "none;"}}>Contraseña erronea</p>
                    </div>
                    ...
                    <div class="container-fluid mt-3 mb-5">
                        <div class="row text-center">
                            ...
                            <input onclick="enviar()" type="button" class=" botonsiguiente " value="Siguiente" name="submit" id="submit"/>
                        </div>
                    </div>
