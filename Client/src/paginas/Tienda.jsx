    ...
    <>
      <div className="tw-min-h-screen tw-bg-black">
        ...
        <div className="tw-flex tw-justify-center ">
          <h1 className="tw-font-bold tw-text-white tw-mt-16 tw-text-7xl">carrito D</h1>
        </div>
        <div className="tw-flex tw-pla tw-flex-wrap tw-gap-4 tw-mt-1"> {/* tw-grid md:tw-grid-cols-2 xl:tw-grid-cols-4*/}
