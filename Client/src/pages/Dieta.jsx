    ...
    <>
      <div className="tw-min-h-screen  tw-bg-[#0d0d0d] tw-pt-[4.87rem] tw-px-4" style={{ fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont' }}>
        ...
        <section className="tw-flex tw-justify-between tw-w-full tw-flex-wrap tw-text-white tw-rounded-md tw-mb-[5vh] tw-h-[100vh] tw-items-center ">
          <div className="tw-w-full tw-bg-slate-700 tw-mt-3 tw-text-center tw-p-3 tw-rounded-md sm:tw-h-[10%] lg:tw-h-[6.5%] tw-flex tw-items-center">
          ...
          <div className="tw-w-full tw-h-3/5 lg:tw-h-2/5 sm:tw-h-1/2  lg:tw-flex-nowrap tw-bg-slate-700 tw-roudned-md tw-flex tw-flex-wrap  tw-justify-between tw-p-3 tw-rounded-md tw-mt-[5%] tw-px-5">
