      ...
      <div className="tw-min-h-screen  tw-bg-[#0d0d0d] tw-pt-[4.87rem] tw-px-4" style={{ fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont' }}>
        ...
        <section className=" tw-w-full  tw-text-white tw-rounded-xl  tw-h-[100vh] ">
          <div className="lg:tw-px-[10%] tw-w-full tw-h-[38%] ">
            <div className="tw-w-full tw-text-center tw-h-full tw-px-3 tw-pb-3 tw-rounded-xl  tw-flex tw-flex-wrap tw-items-center lg:tw-bg-slate-800 ">
              <div className="tw-flex  tw-justify-between tw-px-5 tw-w-full tw-h-1/4 tw-items-center lg:tw-border-b tw-bg-slate-800 lg:tw-rounded-none tw-rounded-xl lg:tw-border-gray-400">
              ...
              <div className="tw-w-full tw-justify-center tw-h-2/3 lg:tw-px-[10%]">
                <div className="tw-flex tw-items-center  tw-w-full tw-h-full tw-justify-between  tw-pointer-events-none  tw-text-sm lg:tw-text-xs tw-px-3 md:tw-px-16 xl:tw-px-[20%] xl:tw-bg-slate-800 tw-rounded-xl">
              ...
              <div className="tw-w-full tw-flex tw-justify-between">
                <div className="tw-w-1/2 tw-flex tw-items-center tw-justify-center gap-3">
