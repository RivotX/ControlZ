        ...
        <>
            <div className="tw-fixed tw-top-0 tw-z-10 tw-text-black tw-left-0 tw-w-screen tw-h-screen NegroOpacidad75 tw-flex tw-items-center tw-justify-center">
                ...
                <div className="tw-bg-white  tw-mx-2 tw-p-8 tw-rounded-lg tw-w-full tw-h-4/6 md:tw-w-4/5 lg:tw-w-3/5 tw-opacity-100 ">
                    <span>logueate mamahuevo gonorrea</span>
                    <div class="tw-flex tw-items-center tw-p-4 tw-mb-4 tw-text-sm tw-text-red-800 tw-border tw-border-red-300 tw-rounded-lg tw-bg-red-50 tw-dark:bg-gray-800 tw-dark:text-red-400 tw-dark:border-red-800" role="alert">
                        ...
                        <div>
                            <span class="tw-font-medium">Necesitas iniciar sesion para poder utilizar esta funcionalidad </span>⚠️
                        </div>
                    </div>
